...
# -------------------------
[channels]
# Channel-specific encryption keys (base64 encoded)
# Keys can be 128-bit (16 bytes) or 256-bit (32 bytes)
# Format: channel_name = base64_key
# If a channel is not listed, the default Meshtastic key will be used
# Example:
# MyChannel = YourBase64EncodedKeyHere==
# AnotherChannel = AnotherBase64KeyHere==
